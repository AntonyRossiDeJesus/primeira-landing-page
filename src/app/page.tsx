...
import React, { useEffect, useRef, useCallback, useState, useMemo, JSX } from 'react';
  ...
  const floatingCodeSnippets: FloatingCodeSnippet[] = [
    {
      ...
      className: 'absolute top-20 left-10 text-green-400 font-mono text-sm opacity-60 animate-bounce',
      style: {}
    },
    {
      id: 'snippet-2',
      text: 'const hello = "world"',
      className: 'absolute top-40 right-10 text-blue-400 font-mono text-sm opacity-60 animate-bounce',
      style: { animationDelay: '0.5s' }
    },
    {
      id: 'snippet-3',
      text: 'import React from "react"',
      className: 'absolute bottom-40 left-20 text-purple-400 font-mono text-sm opacity-60 animate-bounce',
      style: { animationDelay: '1s' }
    },
    {
      id: 'snippet-4',
      text: 'export default Hero',
      className: 'absolute bottom-20 right-20 text-pink-400 font-mono text-sm opacity-60 animate-bounce',
  ...
  return (
    <div className="relative min-h-screen overflow-hidden bg-black">
      ...
      <div className="relative z-10 flex items-center justify-center min-h-screen px-4">
        <div className="text-center space-y-8 max-w-4xl mx-auto">
          ...
          <p className="text-lg md:text-xl text-gray-300 font-mono tracking-wide max-w-3xl mx-auto leading-relaxed">
            ...
            <br />
            <span className="text-green-400 font-bold">SOFTWARE WITH AI, CHAT,</span>
            <br />
            <span className="text-purple-400 font-bold">AGENTS, AND BEYOND</span>
          </p>
      ...
      <style jsx>{`
        ...
        @keyframes textGlow {
          from { 
            text-shadow: 0 0 20px rgb(139, 92, 246), 0 0 40px rgb(139, 92, 246), 0 0 60px rgb(139, 92, 246); 
          }
          to { 
            text-shadow: 0 0 30px rgb(139, 92, 246), 0 0 50px rgb(139, 92, 246), 0 0 70px rgb(139, 92, 246), 0 0 90px rgb(139, 92, 246); 
          }
        }
